    ...
    public function updateLegalEntity(): RedirectResponse|Redirector|null
    {
        ...
        if ($this->isOwnerChanged) {
            try {
                ...
                return app(Logout::class)(message: __('forms.replace_successful'));
            } catch (Exception $err) {
        ...
        return Redirect::route('legal-entity.edit', [legalEntity()])->with('success', __('forms.le_update_successful')) ?? null;
    }
