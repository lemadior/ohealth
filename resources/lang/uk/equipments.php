...
return [
    ...
    'policy' => [
        ...
        'sync' => 'У вас немає дозволу на синхронізацію обладнань'
    ],

    'errors' => [
        'sync_failed' => 'Виникла помилка. Оновіть список місць надання послуг та співробітників і спробуйте ще раз'
    ],
