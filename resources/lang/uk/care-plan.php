...
return [
    ...
    'conditions_of_service' => 'Умови надання послуг',
...
лікарських засобів за призначенням з цього плану лікування після цієї дати будуть неможливі!',
    ...
    'diagnoses_conditions' => 'Діагнози (Стани)',
    'no_justification_added' => 'Немає доданих обґрунтувань',
    'enter_service_search_query' => 'Введіть запит для пошуку послуг',
    'nothing_found_for_query' => 'Нічого не знайдено за запитом',
    'nothing_found_by_filters' => 'Нічого не знайдено за обраними фільтрами',
    'medical_record_type' => 'Тип медичних записів',
    'all_types' => 'Всі типи',
    'select_episode_placeholder' => 'Оберіть епізод...',
    'health_maintenance_prevention_active_from' => 'Підтримання здоров\'я/профілактика (діючий) від',
    'diagnostic_report' => 'Діагностичний звіт',
    'ehealth_search_error' => 'Помилка пошуку планів лікування в ЕСОЗ: ',
    'sync_success' => 'Синхронізація планів закладу успішна',
    'sync_error' => 'Помилка синхронізації: ',
    'status_reason' => 'Обґрунтування зміни статусу',
    'outcome_code' => 'Результат (довідник)',
    'condition_diagnosis_type' => 'Стан/Діагноз',
    'observation_type' => 'Спостереження',
    'unknown_document' => 'Невідомий документ',
    'failed_to_load_auth_methods' => 'Не вдалося завантажити методи аутентифікації',
    'care_plan_activated' => 'План лікування успішно активовано.',
    'failed_to_create_approval_request' => 'Не вдалося створити запит на дозвіл: ',
    'invalid_verification_code' => 'Невірний код підтвердження або помилка сервісу',
    'sms_resent' => 'SMS надіслано повторно',
    'data_synced_success' => 'Дані успішно синхронізовано з ЕСОЗ',
    'care_plan_no' => 'План лікування №',
    'sync_data_with_ehealth' => 'Синхронізувати дані з ЕСОЗ',
    'cancel_care_plan_btn' => 'Відмінити план лікування',
    'status_label' => 'Статус',
    'complete' => 'Завершити',
