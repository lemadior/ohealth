                                    ...
                                    <div class="record-inner-body">
                                        <div class="record-inner-grid-container">
                                            <div class="grid grid-cols-2 xl:grid-cols-4 gap-y-4 gap-x-4 w-full [&>div]:min-w-0 [&_.record-inner-subvalue]:break-words">
                                                <div><div class="record-inner-label">{{ __('patients.category') }}</div><div class="record-inner-subvalue">Побутова</div></div>
                                                <div><div class="record-inner-label">{{ __('patients.doctor') }}</div><div class="record-inner-subvalue">Сидоренко О.В.</div></div>
                                                <div><div class="record-inner-label">{{ __('patients.created') }}</div><div class="record-inner-subvalue">02.02.2025</div></div>
                                                <div></div>

                                                <div><div class="record-inner-label">{{ __('patients.criticality') }}</div><div class="record-inner-subvalue">Високий</div></div>
                                                <div><div class="record-inner-label">{{ __('patients.verification_status') }}</div><div class="record-inner-subvalue">Підтверджена</div></div>
